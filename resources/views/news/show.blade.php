                ...
                <nav class="flex mb-4" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
                        <li class="inline-flex items-center">
                            <a href="{{ route('home') }}" class="text-sm font-medium text-gray-500 hover:text-yemdat-brown transition">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('news') }}" class="text-sm font-medium text-gray-500 hover:text-yemdat-brown transition ml-1 md:ml-2">
                                    {{ __('nav.news') }}
                                </a>
                            </div>
                        </li>
