<nav x-data="{ open: false }" class="bg-yemdat-beige">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20"> <!-- Increased height for better spacing -->
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 gap-4">
                <a href="{{ route('membership') }}" class="inline-flex items-center px-4 py-2 bg-yemdat-brown border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-yemdat-brown/90 focus:bg-yemdat-brown/90 active:bg-yemdat-brown focus:outline-none focus:ring-2 focus:ring-yemdat-gold focus:ring-offset-2 transition ease-in-out duration-150">
                    {{ __('home.btn_join') }}
                </a>

                @if (app()->getLocale() == 'en')
                    <a href="{{ route('lang.switch', 'ar') }}" class="flex items-center text-sm font-medium text-gray-500 hover:text-yemdat-brown hover:border-gray-300 focus:outline-none focus:text-yemdat-brown focus:border-gray-300 transition duration-150 ease-in-out">
                ...
                @else
                    <a href="{{ route('lang.switch', 'en') }}" class="flex items-center text-sm font-medium text-gray-500 hover:text-yemdat-brown hover:border-gray-300 focus:outline-none focus:text-yemdat-brown focus:border-gray-300 transition duration-150 ease-in-out">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-1">
                             <path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S13.627 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.627 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418" />
                        </svg>
                        EN
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <a href="{{ route('membership') }}" class="block pl-3 pr-4 py-2 border-l-4 border-yemdat-gold text-yemdat-brown bg-yemdat-gold/10 font-bold focus:outline-none transition duration-150 ease-in-out">
                {{ __('home.btn_join') }}
            </a>
            
             <!-- Language Switcher Mobile -->
            @if (app()->getLocale() == 'en')
                <a href="{{ route('lang.switch', 'ar') }}" class="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none transition duration-150 ease-in-out">
                    <div class="flex items-center">
            ...
            @else
                <a href="{{ route('lang.switch', 'en') }}" class="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none transition duration-150 ease-in-out">
                     <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2">
                             <path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S13.627 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.627 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418" />
                        </svg>
