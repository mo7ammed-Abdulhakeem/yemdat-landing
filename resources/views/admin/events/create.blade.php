<x-admin-layout>
                    ...
                    <form id="createEventForm" action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="title_en" id="title_en" value="{{ old('title_en') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50" required>
                            ...
                            <div dir="rtl">
                                ...
                                <input type="text" name="title_ar" id="title_ar" value="{{ old('title_ar') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50" required>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="start_date" id="start_date" value="{{ old('start_date') }}" min="{{ now()->format('Y-m-d\TH:i') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50" required>
                                <p class="text-xs text-yemdat-brown mt-1">Must be in the future.</p>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_date" id="end_date" value="{{ old('end_date') }}" min="{{ now()->format('Y-m-d\TH:i') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50">
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="text" name="location" id="location" value="{{ old('location') }}" placeholder="e.g. Zoom Link or Sana'a, Yemen" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="lecturer_name_en" id="lecturer_name_en" value="{{ old('lecturer_name_en') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50" required>
                             ...
                             <div dir="rtl">
                                ...
                                <input type="text" name="lecturer_name_ar" id="lecturer_name_ar" value="{{ old('lecturer_name_ar') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="lecturer_title_en" id="lecturer_title_en" value="{{ old('lecturer_title_en') }}" placeholder="e.g. Senior Developer" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50">
                            ...
                            <div dir="rtl">
                                ...
                                <input type="text" name="lecturer_title_ar" id="lecturer_title_ar" value="{{ old('lecturer_title_ar') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50">
                            ...
                            <div class="col-span-2">
                                <div>
                                    ...
                                    <input id="lecturer_linkedin" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50" type="url" name="lecturer_linkedin" value="{{ old('lecturer_linkedin') }}" placeholder="https://linkedin.com/in/..." />
                        ...
                        <div class="flex items-center mb-6">
                            <input type="checkbox" name="is_active" id="is_active" class="h-4 w-4 text-yemdat-gold focus:ring-yemdat-brown border-gray-300 rounded" checked>
    ...
    <script>
        ...
        var oldContentEn = document.getElementById('description_en').value;
        if (oldContentEn) {
        ...
        // Load old data if exists
        var oldContentAr = document.getElementById('description_ar').value;
        if (oldContentAr) {
