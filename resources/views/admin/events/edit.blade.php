                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div class="col-span-2">
                                ...
                                <div>
                                    ...
                                    <input id="join_url" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50" type="url" name="join_url" value="{{ old('join_url', $event->join_url) }}" placeholder="https://zoom.us/j/..." />
