        ...
        <div class="mb-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl">
                <div class="p-8 bg-white border-b border-gray-200">
                    <form id="createPostForm" action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="tags" id="tags" value="{{ old('tags') }}" placeholder="e.g. SEO, Medicine, News" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yemdat-brown focus:ring focus:ring-yemdat-gold focus:ring-opacity-50">
                            ...
                            <div class="col-span-2">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Max size: 2MB. Image will scale out to fit the block automatically.</p>
                        ...
                        <div class="flex items-center mb-6">
                            <input type="checkbox" name="is_published" id="is_published" class="h-4 w-4 text-yemdat-gold focus:ring-yemdat-brown border-gray-300 rounded" checked>
