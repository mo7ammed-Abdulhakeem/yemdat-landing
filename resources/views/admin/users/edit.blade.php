                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div id="permissions-container">
                            ...
                            <div class="space-y-2 border border-gray-200 p-4 rounded-lg bg-gray-50">
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="permissions[]" value="posts" class="rounded border-gray-300 text-yemdat-brown focus:ring-yemdat-brown" {{ in_array('posts', $user->permissions ?? []) ? 'checked' : '' }}>
                                    <span class="ml-2 text-gray-700">News/Posts Management</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="checkbox" name="permissions[]" value="trainers" class="rounded border-gray-300 text-yemdat-brown focus:ring-yemdat-brown" {{ in_array('trainers', $user->permissions ?? []) ? 'checked' : '' }}>
