...
<x-admin-layout>
    ...
    <div class="max-w-4xl">
        ...
        <form action="{{ route('admin.broadcasts.store') }}" method="POST" x-data="broadcastComposer()">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="language" x-model="language"
                            class="w-full border-gray-300 rounded-md focus:border-yemdat-gold focus:ring-yemdat-gold text-sm">
                            <option value="en" {{ old('language', 'en') === 'en' ? 'selected' : '' }}>English only</option>
                            <option value="ar" {{ old('language') === 'ar' ? 'selected' : '' }}>Arabic only (العربية)</option>
                        </select>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6" x-show="language === 'en'" x-transition>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="subject_en" value="{{ old('subject_en') }}"
                        class="w-full border-gray-300 rounded-md focus:border-yemdat-gold focus:ring-yemdat-gold text-sm"
                ...
                <div>
                    ...
                    <textarea name="body_en" id="body-en-hidden" class="hidden">{{ old('body_en') }}</textarea>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6" x-show="language === 'ar'" x-transition>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="subject_ar" value="{{ old('subject_ar') }}" dir="rtl"
                        class="w-full border-gray-300 rounded-md focus:border-yemdat-gold focus:ring-yemdat-gold text-sm"
                ...
                <div>
                    ...
                    <textarea name="body_ar" id="body-ar-hidden" class="hidden">{{ old('body_ar') }}</textarea>
                </div>
            </div>

            {{-- Submit --}}
            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.broadcasts.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm text-gray-700 hover:bg-gray-50 transition">
                    Cancel
                </a>
...
function broadcastComposer() {
    return {
        audienceType: '{{ old('audience_type', 'all_members') }}',
        ...
        syncBeforeSubmit() {
            // Sync HTML source tabs back to hidden fields
