                        ...
                        @foreach($member->events()->orderBy('start_date', 'desc')->get() as $event)
                            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-yemdat-gold transition shadow-sm hover:shadow-md flex flex-col">
                                ...
                                <div class="p-5 flex flex-col flex-grow">
                                    ...
                                    @if($certificatesByEvent->has($event->id))
                                        <div class="mt-4 pt-4 border-t border-gray-100">
                                            <a href="{{ route('certificates.download', $certificatesByEvent->get($event->id)) }}" target="_blank"
                                               class="inline-flex w-full items-center justify-center gap-2 px-4 py-2 bg-yemdat-brown text-white rounded-lg text-sm font-bold hover:bg-yemdat-gold transition">
                                                ...
                                                {{ app()->getLocale() == 'ar' ? 'تحميل الشهادة' : 'Download Certificate' }}
                                            </a>
                                        </div>
                                    @endif
                                </div>
