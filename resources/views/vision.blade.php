    ...
    <div class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-y-16">
            ...
            <div class="flex flex-col gap-y-12">
                <!-- Vision Card -->
                <div class="bg-yemdat-offwhite border border-gray-100 rounded-2xl p-10 flex flex-col md:flex-row items-center gap-8 shadow-sm">
                    ...
                    <div class="flex-1 text-center md:text-start rtl:md:text-right">
                        <h2 class="text-2xl font-bold text-yemdat-brown mb-4">{{ __('vision.vision_title') }}</h2>
                ...
                <div class="bg-yemdat-offwhite border border-gray-100 rounded-2xl p-10 flex flex-col md:flex-row items-center gap-8 shadow-sm">
                    <div class="w-16 h-16 bg-yemdat-gold rounded-full flex items-center justify-center text-white shrink-0">
                     ...
                     <div class="flex-1 text-center md:text-start rtl:md:text-right">
                        <h2 class="text-2xl font-bold text-yemdat-brown mb-4">{{ __('vision.mission_title') }}</h2>
            ...
            <!-- Objectives Section -->
            <div>
                <h2 class="text-2xl font-bold text-yemdat-brown text-center mb-10">{{ __('vision.objectives_title') }}</h2>
                <div class="flex flex-col gap-y-6">
                    @foreach(['obj_1', 'obj_2', 'obj_3', 'obj_4', 'obj_5'] as $obj)
                    <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex items-center gap-6 ltr:border-l-4 rtl:border-r-4 border-yemdat-gold hover:shadow-md transition">
            ...
            <!-- Footer Tagline -->
             <div class="mt-8">
                 <div class="bg-yemdat-offwhite border border-yemdat-gold/30 rounded-2xl p-10 text-center">
