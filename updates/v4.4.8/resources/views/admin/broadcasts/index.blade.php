                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <div class="flex flex-wrap items-center gap-3">
                                                <a href="{{ route('admin.broadcasts.show', $broadcast) }}" class="text-indigo-600 hover:text-indigo-900 whitespace-nowrap">View</a>
                                                @if($broadcast->status === 'draft')
                                                    <a href="{{ route('admin.broadcasts.edit', $broadcast) }}" class="text-yellow-600 hover:text-yellow-900 whitespace-nowrap">Edit</a>
                                                @endif
                                                <form action="{{ route('admin.broadcasts.destroy', $broadcast) }}" method="POST"
                                                      onsubmit="return confirm('Permanently delete this broadcast and all its recipient records?');">
                                                    @csrf
                                                    @method('DELETE')
