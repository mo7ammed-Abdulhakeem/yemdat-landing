                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div id="permissions-container">
                            ...
                            <div class="space-y-2 border border-gray-200 p-4 rounded-lg bg-gray-50">
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="permissions[]" value="broadcasts" class="rounded border-gray-300 text-yemdat-brown focus:ring-yemdat-brown" {{ is_array(old('permissions')) && in_array('broadcasts', old('permissions')) ? 'checked' : '' }}>
